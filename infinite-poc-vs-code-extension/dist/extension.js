...
exports.registerIntelligence = void 0;
const vscode_1 = __webpack_require__(1);
const intelligence_data_1 = __webpack_require__(3);
const intelligence_type_1 = __webpack_require__(4);
const insideBracketRegxPattern = new RegExp(/(?<=\().+?(?=\))/gi);
const spaceRegxPattern = new RegExp(/\s/gi);
function registerIntelligence(context) {
    context.subscriptions.push(loadInterfaces(getClasses(intelligence_data_1.intelligencePayload)));
    const map = getIntelligence(intelligence_data_1.intelligencePayload);
...
function getCompletionItems(parentKey, intelligencePayload, map) {
    ...
    intelligencePayload.child?.forEach(element => {
        ...
        const c = new vscode_1.CompletionItem(element.name, element.type == intelligence_type_1.IntelligenceType.Method ? vscode_1.CompletionItemKind.Method : vscode_1.CompletionItemKind.Property);
        c.detail = element.returnType ?? element.Doc;
        c.documentation = element.Doc;
        c.insertText = element.name;
        commands.push(c);
...
exports.intelligencePayload = [{
        name: "Demo",
        Doc: "POC demo",
        type: intelligence_type_1.IntelligenceType.Class,
        child: [{
                Doc: "Demo name",
                name: "Name",
                type: intelligence_type_1.IntelligenceType.Property,
                returnType: "String"
            }, {
                Doc: "Demo details",
                name: "Details(field: string)",
                type: intelligence_type_1.IntelligenceType.Method,
                returnType: "Detail",
                child: [{
                        name: "IsValid",
                        Doc: "is it valid",
...
})(IntelligenceType = exports.IntelligenceType || (exports.IntelligenceType = {}));
...
const vscode_1 = __webpack_require__(1);
function registerCacheCommand(context) {
...
function registeripocShowSecretStorage(context) {
    context.subscriptions.push(vscode_1.commands.registerCommand('ipoc.show.secret.storage', async () => {
        const value = await context.secrets.get('ipocCacheKey');
        vscode_1.window.showInformationMessage('Value from SecretStorage: ' + value ?? '', '');
    }));
}
function registerShowCache(context) {
    context.subscriptions.push(vscode_1.commands.registerCommand('ipoc.show.cache', async () => {
        const key = await vscode_1.window.showQuickPick(context.globalState.keys());
        vscode_1.window.showInformationMessage('Value from cache: ' + context.globalState.get(key ?? '', ''));
    }));
}
function registerClearCache(context) {
    context.subscriptions.push(vscode_1.commands.registerCommand('ipoc.clear.cache', async () => {
        const key = await vscode_1.window.showQuickPick(context.globalState.keys());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.openBrowser = exports.registerCallbackRequest = void 0;
const vscode_1 = __webpack_require__(1);
/**
 ...
 */
function registerCallbackRequest(context) {
    const handleUri = (uri) => {
        console.log(uri);
        const queryParams = new URLSearchParams(uri.query);
        console.log(queryParams);
        if (queryParams.has('token')) {
            vscode_1.window.showInformationMessage(`Token: ${queryParams.get('token')}`);
        }
    };
    context.subscriptions.push(vscode_1.window.registerUriHandler({
        handleUri
    }));
}
exports.registerCallbackRequest = registerCallbackRequest;
function openBrowser() {
    const site = vscode_1.workspace.getConfiguration().get('ipoc.open.browser.sites');
    vscode_1.commands.executeCommand("vscode.open", vscode_1.Uri.parse(site ? site[0] : `https://www.google.com`));
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.readSelectedOrAllText = exports.registerCommands = void 0;
const vscode_1 = __webpack_require__(1);
function registerCommands(context, op) {
    context.subscriptions.push(vscode_1.commands.registerCommand('takeapaws.dialog-modal-message', () => {
        vscode_1.window.showInformationMessage('This is Dialog modal message example', {
            modal: true,
            detail: 'How many cats, do you see 🐈🐈🐈 in the message?'
        }, '1', '2', '3', '4').then(result => processUserSelection(result));
    }));
    context.subscriptions.push(vscode_1.commands.registerCommand('takeapaws.ask-user', () => {
        vscode_1.window.showInformationMessage('How many cats, do you see 🐈🐈🐈 in the message?', '1', '2', '3', '4')
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registerDevToolCommand = void 0;
const vscode_1 = __webpack_require__(1);
function registerDevToolCommand(context) {
    if (context.extensionMode === vscode_1.ExtensionMode.Production) {
        vscode_1.commands.registerCommand('workbench.action.webview.openDeveloperTools', () => { return; });
    }
}
exports.registerDevToolCommand = registerDevToolCommand;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registerWelcomeMessage = void 0;
const vscode_1 = __webpack_require__(1);
function registerWelcomeMessage(context) {
    const enableMessage = vscode_1.workspace.getConfiguration().get('ipoc.welcom.message.enabled');
    if (enableMessage) {
        let message = vscode_1.workspace.getConfiguration().get('ipoc.welcom.message.string');
        let emoji = vscode_1.workspace.getConfiguration().get('ipoc.welcom.message.emoji');
        message = message ?? "Welcome";
        emoji = emoji ?? "🎉";
        vscode_1.window.showInformationMessage(`${message} ${emoji}`);
    }
}
...
class CustomEvent {
    constructor() {
        ...
        this.subscribe = this.eventEmitter.event;
    }
    publish(data) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CenterPanel = exports.registerCenterPanel = void 0;
const vscode_1 = __webpack_require__(1);
const register_callback_request_1 = __webpack_require__(6);
const util_1 = __webpack_require__(12);
function registerCenterPanel(context) {
    context.subscriptions.push(vscode_1.commands.registerCommand('ipoc.show.center.panel', () => {
        CenterPanel.getInstance(context.extensionUri, context);
    }));
    context.subscriptions.push(vscode_1.commands.registerCommand('ipoc.send.data', (data) => {
        vscode_1.window.showInformationMessage('ipoc.send.data: ' + data.data);
    }));
}
exports.registerCenterPanel = registerCenterPanel;
class CenterPanel {
    constructor(webviewPanel, _extensionUri, extensionContext) {
        this.webviewPanel = webviewPanel;
        this._extensionUri = _extensionUri;
        this.extensionContext = extensionContext;
        this.updateView();
    }
    static getInstance(extensionUri, extensionContext) {
        ...
        const panel = vscode_1.window.createWebviewPanel(CenterPanel.viewType, "Extension HTML Feature", column || vscode_1.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [
    ...
    async updateView() {
        ...
        this.webviewPanel.webview.onDidReceiveMessage((data) => {
            switch (data.type) {
                case "btn-first": {
                    (0, register_callback_request_1.openBrowser)();
                    break;
                }
                case 'btn-second': {
                    this.extensionContext.globalState.update('ipocCacheKey', data.value);
                    vscode_1.window.showInformationMessage('Value saved in cache: ' + data.value);
                    break;
                }
                case 'btn-third': {
                    this.extensionContext.secrets.store('ipocCacheKey', data.value);
                    vscode_1.window.showInformationMessage('Value saved in SecretStorage: ' + data.value);
                    break;
                }
            }
        });
    ...
    _getHtmlForWebview(webview) {
        ...
        const scriptUri = webview.asWebviewUri(vscode_1.Uri.joinPath(this._extensionUri, "media", "js", "takeapaws-panel.js"));
        ...
        const happyGif = webview.asWebviewUri(vscode_1.Uri.joinPath(this._extensionUri, "media", "happycat.gif"));
        const sadGif = webview.asWebviewUri(vscode_1.Uri.joinPath(this._extensionUri, "media", "sadcat.gif"));
        const excitedGif = webview.asWebviewUri(vscode_1.Uri.joinPath(this._extensionUri, "media", "excitedcat.gif"));
        const angryGif = webview.asWebviewUri(vscode_1.Uri.joinPath(this._extensionUri, "media", "angrycat.gif"));
        const defaultGif = webview.asWebviewUri(vscode_1.Uri.joinPath(this._extensionUri, "media", "defaultcat.gif"));
        return `<!DOCTYPE html>
        <html lang="en">
            <head>
                <meta charset="UTF-8">
...
CenterPanel.viewType = "CenterPanel";
...
const vscode_1 = __webpack_require__(1);
const register_commands_1 = __webpack_require__(7);
const util_1 = __webpack_require__(12);
function registerWebViewProvider(context, op) {
    const provider = new SidebarWebViewProvider(context.extensionUri, context);
    context.subscriptions.push(vscode_1.window.registerWebviewViewProvider('takeapaws-sidebar-panel', provider));
    context.subscriptions.push(vscode_1.commands.registerCommand('ipoc.print.editor.menu', () => {
        const txt = (0, register_commands_1.readSelectedOrAllText)(op);
...
class SidebarWebViewProvider {
    constructor(_extensionUri, extensionContext) {
        this._extensionUri = _extensionUri;
        this.extensionContext = extensionContext;
        this.emotionFetchInterval = null;
    }
    ...
    async fetchEmotion() {
        try {
            const fetch = (await Promise.resolve().then(() => __webpack_require__(14))).default;
    ...
    startFetchingEmotionData(webview) {
...
/* harmony export */ });
/* harmony import */ var node_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
/* harmony import */ var node_https__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
/* harmony import */ var node_zlib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var node_stream__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18);
/* harmony import */ var node_buffer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(19);
/* harmony import */ var data_uri_to_buffer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(20);
/* harmony import */ var _body_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(21);
/* harmony import */ var _response_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(34);
/* harmony import */ var _headers_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(35);
/* harmony import */ var _request_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(37);
/* harmony import */ var _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(31);
/* harmony import */ var _errors_abort_error_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(42);
/* harmony import */ var _utils_is_redirect_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(36);
/* harmony import */ var formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29);
/* harmony import */ var _utils_is_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(33);
/* harmony import */ var _utils_referrer_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(40);
/* harmony import */ var fetch_blob_from_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(43);
/**
 * Index.js
 *
...
/* harmony export */ });
/* harmony import */ var node_stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18);
/* harmony import */ var node_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22);
/* harmony import */ var node_buffer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(23);
/* harmony import */ var formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29);
/* harmony import */ var _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(31);
/* harmony import */ var _errors_base_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(32);
/* harmony import */ var _utils_is_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(33);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(__webpack_require__, 48));
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
...
if (!globalThis.ReadableStream) {
  ...
  try {
    const process = __webpack_require__(25)
    const { emitWarning } = process
    try {
      process.emitWarning = () => {}
      Object.assign(globalThis, __webpack_require__(26))
...
try {
  ...
  const { Blob } = __webpack_require__(28)
...
/* harmony export */ });
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
...
/* harmony export */ });
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32);
...
/* harmony export */ });
/* harmony import */ var _headers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35);
/* harmony import */ var _body_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
...
/* harmony export */ });
/* harmony import */ var node_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
/* harmony import */ var node_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/**
 * Headers.js
 *
...
/* harmony export */ });
/* harmony import */ var node_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38);
/* harmony import */ var node_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22);
/* harmony import */ var _headers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(35);
/* harmony import */ var _body_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
/* harmony import */ var _utils_is_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(33);
/* harmony import */ var _utils_get_search_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(39);
/* harmony import */ var _utils_referrer_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(40);
/**
 * Request.js
 *
...
/* harmony export */ });
/* harmony import */ var node_net__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41);
...
/* harmony export */ });
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(44);
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(45);
/* harmony import */ var node_domexception__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46);
/* harmony import */ var _file_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30);
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23);
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __webpack_require__(47),
...
const vscode_1 = __webpack_require__(1);
const register_intelligence_1 = __webpack_require__(2);
const cache_operation_1 = __webpack_require__(5);
const register_callback_request_1 = __webpack_require__(6);
const register_commands_1 = __webpack_require__(7);
const register_dev_tool_1 = __webpack_require__(8);
const register_welcome_message_1 = __webpack_require__(9);
const custom_event_1 = __webpack_require__(10);
const register_center_panel_1 = __webpack_require__(11);
const register_webview_provider_1 = __webpack_require__(13);
function activate(context) {
    const op = vscode_1.window.createOutputChannel('TakeAPaws');
    (0, register_commands_1.registerCommands)(context, op);
    (0, cache_operation_1.registerCacheCommand)(context);
    (0, register_welcome_message_1.registerWelcomeMessage)(context);
    (0, register_webview_provider_1.registerWebViewProvider)(context, op);
    (0, register_dev_tool_1.registerDevToolCommand)(context);
    (0, register_callback_request_1.registerCallbackRequest)(context);
    (0, register_center_panel_1.registerCenterPanel)(context);
    (0, register_intelligence_1.registerIntelligence)(context);
    vscode_1.commands.executeCommand('setContext', 'isPrintContextMenu', true);
    custom_event_1.CustomEvent.customEvent.subscribe(data => vscode_1.window.showInformationMessage('Message from event: ' + data));
}
